...
<body>
    ...
    <table class="tablelist">
        ...
        String sql="select * from tbl_dailyOpreation ";
        sql=sql+"limit "+((nowPage-1)*pageSize)+","+pageSize;
        System.out.print(sql);
        String sql1="select count(*) as num from tbl_dailyOpreation";
        ...
        <td><%=list.get(i).get("opreationtime")%></td>
        <td><%=list.get(i).get("opreation")%></td>
        </tr> 
        <%} %>  
        </tbody>
    </table>
