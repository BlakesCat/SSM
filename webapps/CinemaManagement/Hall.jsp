...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li class="click"><a href="HallAdd.jsp"><span><img src="images/t01.png" /></span>添加</a></li>
    ...
    <table class="tablelist">
        ...
        String sql1="select count(*) as num from tbl_hall";
        ...
        <td><%=list.get(i).get("Hall_number") %></td>
        <td><%=list.get(i).get("HallID")%></td>
        <td><%=list.get(i).get("HallSeats")%></td>
        <td><%=list.get(i).get("Description")%></td>
        <td><a href="HallUpdate.jsp?Hall_number=<%=list.get(i).get("Hall_number") %>" class="tablelink">更改</a>     <a href="HallDelete.jsp?Hall_number=<%=list.get(i).get("Hall_number") %>" class="tablelink"> 删除</a></td>
        </tr> 
        <%} %>  
        </tbody>
    </table>
